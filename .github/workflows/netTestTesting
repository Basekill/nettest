...
numHidden = int(input("Enter the number of neurons you want in your hidden layer"))
#default hidden layer: 30
epochs = int(input("Enter the number of epochs you want to train for"))
#default epochs: 10
mini_batch_size = int(input("Enter the size of your mini-batch"))
#default mini-batch: 30
...
save = input("Do you want to save your network? Y/N")

if save.lower() == "y":
    networkName = input("Enter the name of the network ")
    net.findMax()
    #net.writeModel(networkName)
    net.outputResults(networkName)

#query = input("Enter the name of the model you want to search for: ")
#net.databaseToFile()
#net.getModel(query)
# net.getModel("feb","")
#net.showDatabase()
